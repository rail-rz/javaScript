...
function Init() {
    ...
    document.getElementById('content-left-workzone').style.height = sizeControl(heightWindow, 75);
    document.getElementById('content-left-helperzone').style.height = sizeControl(heightWindow, 25);
}
...
function sizeControl( hundredPercentSize, percentage) {
    return (hundredPercentSize * percentage / 100) + "px";
}