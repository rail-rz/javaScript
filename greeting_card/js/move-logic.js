	...
	this.startGame = function() {
		...
		startParams = {
			otherElements: [
                ...
                { method:'rect',   type:'div', color:'blue',  left:500, top:0,   width:100, height:100, speedY:4},
                { method:'rect',   type:'div', color:'green', left:0,   top:0,   width:100, height:100, speedY:5, speedX:5, rotate:40},
                { method:'image',  type:'img', path:'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQL82tckOtHxX4LwHGEFCJ1OxL2JcHWCrJ_FMF8La0FLFlqw-h2cgn2KyZj', left:50, top:50, width:100, height:100, speedY:-3, speedX:-2},
                { method:'sprite', type:'div', path:'images/nlo.png', left:700, top:500, width:100, height:100, speedY:-1, speedX:2, frameX:4, frameY:3, currentFrameX:0,currentFrameY:0, rotate:40}
			]
		};
